...
public class TelaCheckIns extends AbstractController implements EventHandler<ActionEvent>, Initializable {
    ...
    @FXML
    private TableView<edu.uem.sgh.model.table.CheckIn> tableView;
    ...
    private void initTabela() {
        ...
        ObservableList<TableColumn<edu.uem.sgh.model.table.CheckIn, ?>> columns = tableView.getColumns();
        
        for (int i = 0 ; i < columns.size() ; i++) {
            TableColumn<edu.uem.sgh.model.table.CheckIn, ?> tableColumn = columns.get(i);

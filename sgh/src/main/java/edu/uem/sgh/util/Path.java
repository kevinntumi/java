...
public class Path {
    ...
    public static final String REMOTE_DATABASE_URL = "jdbc:mysql://" + REMOTE_DATABASE_BASE_ENDPOINT + "/" + REMOTE_DATABASE_NAME;
    ...
    public static final String LOCAL_DATABASE_PATH = "jdbc:sqlite:" + System.getProperty("user.dir") + "\\" + LOCAL_DATABASE_NAME;
